...
@Composable
fun FavoriteEventCards(
    favoriteList: List<Event>,
    ...
    Column(
        ...
        Row(
            ...
            Text(
                modifier = Modifier
                    ...
                    .weight(1f)
                ,
                text = stringResource(id = R.string.promotion_favorite_title),
            ...
            IconButton(
                modifier = Modifier
                ,
                onClick = onFavoriteArrowClicked
            ) {
                Icon(
                    modifier = Modifier
                    ,
        ...
        EventCards(events = favoriteList, onEventClick = onFavoriteClicked)
    }
}